...
| session-send | This skill should be used when the user asks to notify other session, requests a session handoff, says tell other agent, or needs a cross-session message. |
